...
class FollowLeaderGamePage extends StatefulWidget {
  GameModel gameModel;

  FollowLeaderGamePage({required this.gameModel});

  @override
  State<FollowLeaderGamePage> createState() => _FollowLeaderGamePageState();
}

class _FollowLeaderGamePageState extends State<FollowLeaderGamePage> with TickerProviderStateMixin {
  ...
  goto(ResultInfo resultInfo) async {
    ...
    temp.add(gameModelList[15].gameId);
        ...
        ResultPage(
          ...
          nextLevelTap: () {
            ...
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) {
              return TipsScreen(gameModel: gameModelList[15]);
            }));
          },
        )));
  }
  ...
  void hideItems(int index) {
    if (index == visibleItems.first) {
      print('$index');
      visibleItems.remove(visibleItems.first);
      items[index] = 0;
      print('${visibleItems}');
      index = 0;
      setState(() {});
